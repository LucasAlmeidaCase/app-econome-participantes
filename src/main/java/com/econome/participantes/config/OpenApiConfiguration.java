package com.econome.participantes.config;
...
@OpenAPIDefinition(
        info = @Info(
                title = "API do aplicativo Econome Participantes",
                version = "v1.0",
                description = "API para gerenciamento do aplicativo Econome Participantes"
        )
)
@Configuration
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new io.swagger.v3.oas.models.info.Info()
                        .title("Econome Participantes API")
                        .version("v1.0")
                        .license(new License().name("Apache 2.0")
                                .url("http://www.apache.org/licenses/LICENSE-2.0"))
                        .description("API do aplicativo Econome Participantes"));
    }
}
